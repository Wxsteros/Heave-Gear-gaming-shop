...
#hightschool=inpu hight school name:')
#print(firstname)
#print(hightschool)
...
#print(x+y) x และ y ซึ่งเป็นข้อมูลประเภทตัวอักษรตอน output จะนำอักษรมาเรียงต่อกันและถ้าเป็นประเภทตัวเลขอย่างเช่นตัวแปล wและz ซึ่งถ้าprint(w+z)
...
#x="""Marc Guehi is a player they have an interest in but his fee is expected to be high. Sky Sports News understands a move for him would be more tied to the situation around Konate, than Quansah.Guehi wants to be a first-choice player wherever he goes, if he is to leave Crystal Palace this summer. It does not make sense for him to move on to be a back-up, especially in a season that precedes a World Cup.
